...
<body>
    ...
    <nav>
        <div class="nav-wrapper blue-grey darken-2">
            <div class="container">
                <div class="col s12">
                    <a href="sem1marks.php" class="breadcrumb">Se..</a>
                ...
                <div class="sem1">
                    ...
                    <div class="in1">
                        ...
                        <form action="marktea.php" method="POST">
                            ...
                            foreach ($arr as $i) {
                                $sql1 = "SELECT * from sem4sub where course_code='$i';";
                       ...
                       <div class=\"col s6 offset-s3 l3 offset-l2 m3 offset-m2\">
                            ...
                            <div class="row">
                                <div class="col s4 offset-s4 l4 offset-l5">
                                    <button type="submit" name="sub-sem4in1" class="but">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="in2">
                       ...
                       <div class=\"col s6 offset-s3 l3 offset-l2 m3 offset-m2\">
                            ...
                            <div class="row">
                                <div class="col s4 offset-s4 l4 offset-l5">
                                    <button type="submit" name="sub-sem4in2" class="but">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="se">
                       ...
                       <div class=\"col s6 offset-s3 l3 offset-l2 m3 offset-m2\">
                            ...
                            <div class="row">
                                <div class="col s4 offset-s4 l4 offset-l5">
                                    <button type="submit" name="sub-sem4" class="but">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <center>
        <ul class="pagination ">
            <li class="waves-effect"><a href="sem3marks.php"><i class="material-icons">chevron_left</i></a></li>
            ...
            <li class="active orange"><a href="sem4marks.php">4</a></li>
            <li class="waves-effect"><a href="sem5marks.php">5</a></li>
            <li class="waves-effect"><a href="sem6marks.php">6</a></li>
            <li class="waves-effect"><a href="sem5marks.php"><i class="material-icons">chevron_right</i></a></li>
        </ul>
    </center>
    <!--footer-->
    <?php

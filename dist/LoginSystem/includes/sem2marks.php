...
<body>
        ...
        <div class="nav-wrapper blue-grey darken-2">
            <div class="container">
                <div class="col s12">
                    ...
                    <a href="sem2marks.php" class="breadcrumb">Semester 2</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="update-marks">
            <div class="container">
                <div class="sem1">
                    <center>
                        <h1 class="titsem black-text">Semester 2 Marks</h1>
                    </center>
                    <br />
                    <div class="in1">
                        <?php
                ...
                foreach ($arr as $i) {
                    $sql1 = "SELECT * from sem2sub where course_code='$i';";
                ...
                <div class="row">
                    <div class="col s4 offset-s4 l4 offset-l5">
                        <button type="submit" name="sub-sem2in1" class="but">Update</button>
                    </div>
                </div>
                </form>
            </div>
        ...
        <div class="row">
            <div class="col s4 offset-s4 l4 offset-l5">
                <button type="submit" name="sub-sem2in2" class="but">Update</button>
            </div>
        </div>
        </form>
    </div>
    ...
    <div class="row">
        <div class="col s4 offset-s4 l4 offset-l5">
            <button type="submit" name="sub-sem2" class="but">Update</button>
        </div>
    </div>
    </form>
    </div>
    ...
    <center>
        <ul class="pagination ">
            <li class="waves-effect"><a href="sem1marks.php"><i class="material-icons">chevron_left</i></a></li>
            <li class="waves-effect"><a href="sem1marks.php">1</a></li>
            <li class="active orange"><a href="sem2marks.php">2</a></li>
            ...
            <li class="waves-effect"><a href="sem3marks.php"><i class="material-icons">chevron_right</i></a></li>
        </ul>
    </center>
    <br />
    <br />

...
<body>
    ...
    <div class="container">
        <div class="update-marks">
            <div class="container">
                <div class="sem1">
                    <center>
                        <h1 class="titsem black-text">Semester 6 Marks</h1>
                    </center>
                    <br />
                    <?php
                    ...
                    <div class="in1">
                        ...
                        <form action="marktea.php" method="POST">
                            ...
                            foreach ($arr as $i) {
                                $sql1 = "SELECT * from sem6sub where course_code='$i';";
                       ...
                       <div class=\"col s6 offset-s3 l3 offset-l2 m3 offset-m2\">
                            ...
                            <div class="row">
                                <div class="col s4 offset-s4 l4 offset-l5">
                                    <button type="submit" name="sub-sem6in1" class="but">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="in2">
                       ...
                       <div class=\"col s6 offset-s3 l3 offset-l2 m3 offset-m2\">
                            ...
                            <div class="row">
                                <div class="col s4 offset-s4 l4 offset-l5">
                                    <button type="submit" name="sub-sem6in2" class="but">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="se">
                       ...
                       <div class=\"col s6 offset-s3 l3 offset-l2 m3 offset-m2\">
                            ...
                            <div class="row">
                                <div class="col s4 offset-s4 l4 offset-l5">
                                    <button type="submit" name="sub-sem6" class="but">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <center>
        <ul class="pagination ">
            <li class="waves-effect"><a href="sem5marks.php"><i class="material-icons">chevron_left</i></a></li>
            ...
            <li class="active orange"><a href="sem6marks.php">6</a></li>
